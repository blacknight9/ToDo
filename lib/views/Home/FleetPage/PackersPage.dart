...
import 'package:ent5m/views/Home/FleetPage/PackersListPage.dart';
    ...
    return Scaffold(
      ...
      actions: [
        ...
        IconButton(onPressed: (){
          Get.to(()=>PackersListPage(),transition: Transition.downToUp);
        }, icon: Icon(Icons.bus_alert_outlined,color: Colors.grey.shade100,)),
        IconButton(onPressed: (){
